...
final class StagingInternalEmailSeeder
{
    ...
    private function ensurePositions(array $fixtures): array
    {
        return [
            ...
            'global_admin_ops' => $this->findOrCreatePosition([
                'key_name' => 'staging_global_admin_ops',
                'name' => 'Staging Global Admin Ops',
                'code' => 'STGIMM-GADO',
                'description' => 'Staging admin operations validation position',
                'hierarchy_type' => 'global',
                'hierarchy_id' => $fixtures['global']['id'],
                'level' => 1,
                'is_executive' => 1,
    ...
    private function buildUserPlans(array $fixtures, array $positions): array
    {
        return [
            ...
            [
                ...
                'role' => 'admin',
                'position' => $positions['global_admin_ops'],
                'scope' => ['level' => 'global', 'global_id' => $fixtures['global']['id']],
            ],
            [
                'first_name' => 'Bontu',
